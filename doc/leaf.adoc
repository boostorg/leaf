...
----
[.text-right]
<<result::result>> | <<result::operator_eq>> | <<result::has_value>> | <<result::has_error>> | <<result::operator_bool>> | <<result::operator_ptr>> | <<result::operator_deref>> | <<result::value>> | <<result::error>> | <<result::load>>
