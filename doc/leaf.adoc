...
----
[.text-right]
<<result>> | <<new_error>> | <<try_handle_all>> | <<LEAF_CHECK>>
...
----
[.text-right]
<<result>> | <<exception>> | <<try_catch>> | <<LEAF_CHECK>>
...
[.text-right]
<<error_id>> | <<is_error_id>> | <<new_error>> | <<current_error>> | <<polymorphic_context>> | <<context_activator>> | <<activate_context>> | <<LEAF_NEW_ERROR>> | <<LEAF_AUTO>> | <<LEAF_CHECK>>
====
...
return leaf::try_handle_some(
  ...
  []() -> leaf::result<void>
  {
    LEAF_AUTO(r, process_file()); //In case of errors, error objects are stored inside the try_handle_some scope
