...
|====
| https://github.com/zajo/leaf[GitHub] \| <<introduction,Introduction>> \| <<tutorial>> \|  <<synopsis>> \| <<rationale,Design Rationale>> >| Reference: <<functions,Functions>> \| <<types,Types>> \| <<traits,Traits>> \| <<macros,Macros>>
|====
