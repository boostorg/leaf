...
ifndef::backend-pdf[]
= LEAFpass:[<a href="https://ci.appveyor.com/project/zajo/leaf/branch/master"><img style="padding-left:8px; padding-top:21px; float:right; vertical-align: top" src="https://ci.appveyor.com/api/projects/status/u7mq10n8y5ewpre3/branch/master?svg=true"></a> <a href="https://travis-ci.org/zajo/leaf"><img style="padding-top:21px; float:right; vertical-align: top" src="https://travis-ci.org/zajo/leaf.svg?branch=master"></a>]
endif::[]
