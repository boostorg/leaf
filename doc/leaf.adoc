...
TIP: The complete program from this tutorial is available https://github.com/boostorg/leaf/blob/master/example/print_file/print_file_result.cpp?ts=4[here]. The https://github.com/boostorg/leaf/blob/master/example/print_file/print_file_eh.cpp?ts=4[other] version of the same program uses exception handling to report errors (see <<introduction-eh,below>>).
...
TIP: The complete program from this tutorial is available https://github.com/boostorg/leaf/blob/master/example/print_file/print_file_eh.cpp?ts=4[here]. The https://github.com/boostorg/leaf/blob/master/example/print_file/print_file_result.cpp?ts=4[other] version of the same program does not use exception handling to report errors (see the <<introduction-result,previous introduction>>).
