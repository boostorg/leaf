...
A standalone single-header option is available; please `#include <boost/leaf/all.hpp>`.
...
LEAF is formatted as a Boost library, but it does not depend on Boost or anything else.
