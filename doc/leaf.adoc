...
TIP: In our handlers there is no need to specify what exception types we're catching, because `try_catch` always catches exceptions, and we've chosen to not dispatch based on the exception type.
