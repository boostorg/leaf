...
<1> This handler is selected based on the static type of `ec`. If another error is reported, it will be returned to the caller (because this is the only error-handling lambda provided).
