...
void test()
{
	...
	}
	{
		int r = leaf::try_handle_all(
			[]() -> R
			{
				return leaf::new_error(errc_a::a0, e_errc_a<1>{make_error_code(errc_a::a1)}).to_error_code();
			},
	...
	}
	{
		int r = leaf::try_handle_all(
			[]() -> R
			{
				return leaf::new_error(errc_a::a1, e_errc_a<1>{make_error_code(errc_a::a0)}).to_error_code();
			},
